...
def generate_model(
    ...
    for obs_i, agent_cell in enumerate(agent_cells):
        ...
        observations[sub_cell_source_ids,:,obs_i] = actual_cell_mult * (1 - sub_cell_cues[:,None]) # Nothing
        observations[sub_cell_source_ids,:,obs_i+len(agent_cells)] = actual_cell_mult * sub_cell_cues[:,None] # Something
        ...
        for edge_cell_id in edge_cells_ids:
            ...
            observations[sub_cell_source_ids,:,edge_cell_id] = edge_cell_mult * (1 - sub_cell_cues[:,None]) # Nothing
            observations[sub_cell_source_ids,:,edge_cell_id+len(agent_cells)] = edge_cell_mult * sub_cell_cues[:,None] # Something
        ...
        for corner_cell_id in corner_cells_ids:
            ...
            # Sub-cell of the source probabilities
            observations[sub_cell_source_ids,:,corner_cell_id] = corner_cell_mult * (1 - sub_cell_cues[:,None]) # Nothing
            observations[sub_cell_source_ids,:,corner_cell_id+len(agent_cells)] = corner_cell_mult * sub_cell_cues[:,None] # Something
