...
class Agent:
    ...
    def choose_action(self) -> np.ndarray:
        ...
        It should return a 2D array of shape n by 2, where n is how many agents are to choose an action. It should be n 2D vectors of the change the y and x positions.
